...
def processStopwords(baseNewsArticle: bsa.BaseNewsArticle):
    ...
    # tb = TextBlob(newsArticle)
    docWordList = set(baseNewsArticle.getTextBlob().words)
    # print(docWordList)
    # print(f'Total Number of words in List: {docWordList}\n')
    # Stopwords
    stopWordList = getListOfAllStopWords()

    # print(f'Stop Words List: {stopWordList}\n')
    # print(f'है in stop word list: {"है" in stopWordList}')
    # print(f'है in final doc word list: {"है" in docWordList}')
    # print(f' Length: {len(stopWordList)}')
